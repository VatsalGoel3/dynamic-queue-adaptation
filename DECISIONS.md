...
| 2026-04-17 | Phase 2 session simulation uses deterministic synthetic scenarios saved under `data/synthetic` | Frozen |
...
- Deterministic synthetic sessions provide enough structure to test queue-insertion behavior before any recommender logic exists.
- The data and simulation layer is complete once processed catalog and session artifacts can be regenerated locally.
